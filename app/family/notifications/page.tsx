  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: "Marie Dupont vous a envoyé un message concernant Emma",
      date: "Aujourd'hui",
      time: "10:23",
      type: "message",
      read: false,
    ...
    },
    {
      id: 4,
      title: "Nouveau message",
      message: "Isabelle Laurent vous a envoyé un message concernant Lucas",
      date: "Hier",
      time: "11:45",
      type: "message",
      read: true,
      sender: "Isabelle Laurent",
      link: "/family/messages",
    },
    {
      id: 5,
      title: "Attestation fiscale disponible",
      message: "Votre attestation fiscale pour l'année 2023 est disponible",
      date: "Il y a 2 jours",
      time: "16:20",
      type: "document",
      read: true,
    ...
    },
    {
      ...
      message: "Marie Dupont a modifié ses disponibilités pour la semaine prochaine",
      date: "Il y a 3 jours",
      time: "09:10",
      type: "calendar",
      read: true,
